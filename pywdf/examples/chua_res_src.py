...
class Chua(Circuit):
    ...
    def process_sample_chua(self, sample: float) -> float:
        ...
        """
        self.Vin_prev_i = self.Vin.wave_to_current()
        print('i: ', self.Vin_prev_i)

        # self.Vs.set_voltage(0.0)
        # self.Vin.set_voltage(sample)
        self.Vin.set_voltage( sample + self.Vin_prev_i * 1.428e3 )
        self.NL.accept_incident_wave(self.P1.propagate_reflected_wave())
        self.P1.accept_incident_wave(self.NL.propagate_reflected_wave())
        ...
        print('v: ', self.Vin_prev_i * 1.428e3 )
        # self.Vin.set_voltage( self.Vin_prev_i * 1e-3 )

        return self.Vin.wave_to_voltage(), self.Vin_prev_i, self.L3.wave_to_current() 
