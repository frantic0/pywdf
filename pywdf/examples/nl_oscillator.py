...
if __name__ == "__main__":
    ...
    nl_oscillator = NLOscillator(fs)
    nl_oscillator.set_params(frequency, switch_closed, decibels)  # update params
    ...
    nl_oscillator.plot_freqz(
        out_path
    )

    # generate sinusoid
    out = nl_oscillator.process_signal(np.ones((int(fs))))
